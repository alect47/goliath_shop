...
describe Order, type: :model do
  ...
  describe 'instance methods' do
    ...
    it "can sort orders" do
      ...
      user_address_1 = user_1.addresses.create!(address: '123 Main st', city:'Denver', state:'CO', zip:80219)
      user_2 = User.create!(  name: "ac",
        email: "6@gmail.com",
        password: "password"
      )
      ...
      order_1 = user_1.orders.create!( address_id: user_address_1.id, status: 2)
      order_4 = user_1.orders.create!( address_id: user_address_1.id, status: 0)
    ...
    it 'shipped' do
      ...
      @regular_user_address = @regular_user_2.addresses.create!(address: '123 Main st', city:'Denver', state:'CO', zip:80219)

      @order_2 = @regular_user_2.orders.create(address_id: @regular_user_address.id, status: 1)
