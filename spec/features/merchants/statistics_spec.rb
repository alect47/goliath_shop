...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      ...
      @user_address_1 = @user.addresses.create!(address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033)
      @user_address_2 = @user.addresses.create!(address: '123 Zanti St', city: 'Denver', state: 'CO', zip: 80204)
      @user_address_3 = @user.addresses.create!(address: '123 Dao St', city: 'Denver', state: 'CO', zip: 80210)
      ...
      @order_2 = @user.orders.create!(address_id: @user_address_2.id)
      @order_3 = @user.orders.create!(address_id: @user_address_3.id)
