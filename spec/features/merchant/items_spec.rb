...
describe "As a mechant admin" do
  before(:each) do
    ...
    @user = User.create!(name: "alec", email: "a@gmail.com", password: "password", role: 2, merchant_id: @bike_shop.id)
    @user_address = @user.addresses.create!(address: "234 Main", city: "Denver", state: "CO", zip: 80204)
    ...
    @merchant_admin = User.create(name: "alec", email: "alec@gmail.com", password: "password", role: 2, merchant_id: @bike_shop.id)
    @merchant_admin_address = @merchant_admin.addresses.create!(address: "234 Main", city: "Denver", state: "CO", zip: 80204)
